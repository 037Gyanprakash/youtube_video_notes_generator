...
# from prompts import PROMPTS, WORD_LIMITS, ICONS
# from transcript import extract_video_id, extract_transcript
...
# if "summary_type_used" not in st.session_state:
#     st.session_state.summary_type_used = None

# # ── Title section ─────────────────────────────────────────────────────────────
# st.markdown('<div class="app-title">🎬 YouTube AI Summarizer</div>', unsafe_allow_html=True)
# st.markdown('<div class="app-subtitle">Paste any YouTube link · Choose your depth · Get instant AI-powered notes</div>', unsafe_allow_html=True)
...
#     st.markdown('<div class="section-label" style="margin-top:1.4rem;">📏 Summary Length</div>', unsafe_allow_html=True)
...
#     selected_key = length_map[summary_length]
#     st.session_state.summary_length = selected_key

#     # Word limit hint
#     st.markdown(
#         f'<div style="color:#6b7280;font-size:0.78rem;margin-top:0.3rem;">'
...
#         else:
#             with st.spinner(f"Fetching transcript & generating {selected_key} summary..."):
#                 try:
...
#         # Header row
#         col_head, col_dl = st.columns([7, 3])
#         with col_head:
#             st.markdown(
...
#                 file_name=f"summary_{length_used.lower()}.txt",
#                 mime="text/plain",
#                 use_container_width=True
#             )

#         # ✅ FIXED: Single st.markdown call to avoid empty ghost box
#         st.markdown(
#             f'<div class="summary-box">{st.session_state.summary_output}</div>',
#             unsafe_allow_html=True
#         )
...
#                 <div style="font-family:'Syne',sans-serif;font-weight:700;font-size:1rem;color:#4f8ef7;">
#                     Your summary will appear here
#                 </div>
#                 <div>
#                     Enter a YouTube URL on the left,<br>
#                     choose a summary length, and hit <b>Generate</b>.
#                 </div>
#             </div>
#             ''',
#             unsafe_allow_html=True
